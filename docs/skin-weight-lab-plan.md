...
| Original-scale interaction regression | **Approved** | Camera framing/navigation, numeric and viewport AABB interaction, scale-aware sensitivity, markers, and skeleton alignment worked on the original rat. Camera motion feels more sensitive at this scale; this is explicitly accepted and will not be changed. |
