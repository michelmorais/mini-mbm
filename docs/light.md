...
The LBS/DQS declarations and deformation statements are generated by one private GLES source helper
shared by the production default shader and the numeric CPU/GPU parity harness. Consequently the
harness does not maintain a second handwritten copy of the skinning formula.
