...
selected-frame simplification for non-skeletal geometry animation. Articulated animation and a
shared collapse sequence across multiple geometry frames remain later slices.
...
This is distinct from the later shared-collapse mode needed by assets that require vertex
