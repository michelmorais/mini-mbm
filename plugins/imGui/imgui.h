...
namespace ImGui
{
    ...
    IMGUI_API void          IsScrollVisible(bool* x, bool * y);                             // get the state of scrool (visible/not visible)
    ...
    IMGUI_API void          ImageQuad(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 , const ImVec2& uv1, const ImVec2& uv2,const ImVec2& uv3 , const ImVec4& tint_col = ImVec4(1,1,1,1), const ImVec4& border_col = ImVec4(0,0,0,0));
